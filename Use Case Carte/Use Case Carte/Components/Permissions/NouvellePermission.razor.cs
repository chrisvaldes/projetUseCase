...
{
    public partial class NouvellePermission : ComponentBase
    {
        [Inject]
        ...
        private readonly ILogger<NouvellePermission> _logger;
 
        public NouvellePermission(ILogger<NouvellePermission> logger)
        {
            _logger = logger;
        }
